...
namespace Checkout.Tests.Disputes
{
    public class GetDisputeEvidenceTests : IClassFixture<ApiTestFixture>
    {
        ...
        public async Task CanGetDisputeEvidence()
        {
            ...
            await _api.Disputes.SubmitDisputeEvidenceAsync(id: dispute.Id);
            ...
            var getDisputeEvidenceResponse = await _api.Disputes.GetDisputeEvidenceAsync(id: dispute.Id);

            getDisputeEvidenceResponse.ShouldNotBeNull();
            getDisputeEvidenceResponse.DisputeEvidence.Count.ShouldBeGreaterThan(0);
        }
    }
}
