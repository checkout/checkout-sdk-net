...
namespace Checkout.Risk.Previous
{
    public class RiskIntegrationTest : SandboxTestFixture
    {
        public RiskIntegrationTest() : base(PlatformType.Previous)
        {
        }
        ...
        private async Task ShouldRiskCustomerSource()
        {
            ...
            var customerResponse = await PreviousApi.CustomersClient().Create(customerRequest);
