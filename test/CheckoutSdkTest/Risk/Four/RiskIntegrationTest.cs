...
namespace Checkout.Risk.Four
{
    ...
    {
        public RiskIntegrationTest() : base(PlatformType.Four)
        {
        }
        ...
        private async Task ShouldRiskCustomerSource()
        {
            ...
            var customerResponse = await FourApi.CustomersClient().Create(customerRequest);
        ...
        private async Task TestRequestPreAuthenticationRiskScan(RiskPaymentRequestSource requestSource)
        {
            ...
            var response = await FourApi.RiskClient()
        ...
        private async Task TestPreCaptureAssessmentRequest(RiskPaymentRequestSource requestSource)
        {
            ...
            var response = await FourApi.RiskClient().RequestPreCaptureRiskScan(preCaptureAssessmentRequest);
