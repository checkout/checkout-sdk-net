    ...
    public class CardholdersClientTest : UnitTestFixture
    {
        ...
        private async Task ShouldGetCardholderDetails()
        {
            ...
            CardholderDetailsResponse response =
                await client.GetCardholderDetails("cardholder_id", CancellationToken.None);
        ...
        private async Task ShouldGetCardholderCards()
        {
            ...
            CardholderCardsResponse response =
                await client.GetCardholdersCards("cardholder_id", CancellationToken.None);
