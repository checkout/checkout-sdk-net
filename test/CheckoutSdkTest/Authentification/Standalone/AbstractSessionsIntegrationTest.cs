...
using Checkout.Authentication.Standalone.POSTSessions.Requests.RequestASessionRequest.BillingDescriptor;
...
using Checkout.Authentication.Standalone.POSTSessions.Requests.RequestASessionRequest.Marketplace;
...
namespace Checkout.Authentification.Standalone
{
    public abstract class AbstractSessionsIntegrationTest : SandboxTestFixture
    {
            ...
            TransactionType transactionType)
        {
            ...
            var homePhone = new HomePhone { CountryCode = CountryCode.GB, Number = "1234567890" };

            var mobilePhone = new MobilePhone { CountryCode = CountryCode.GB, Number = "0987654321" };

            var workHome = new WorkPhone { CountryCode = CountryCode.GB, Number = "1122334455" };
            ...
            var sessionRequest = new RequestASessionRequest
            {
                ...
                Marketplace = new Marketplace { SubEntityId = "ent_ocw5i74vowfg2edpy66izhts2u" },
                AuthenticationCategory = authenticationCategory,
                ChallengeIndicator = challengeIndicator,
                BillingDescriptor = new BillingDescriptor { Name = "SUPERHEROES.COM" },
                Reference = "ORD-5023-4E89",
                TransactionType = transactionType,
                ShippingAddress = shippingAddress,
                Completion = new NonHostedCompletion { CallbackUrl = "https://merchant.com/callback" },
                ChannelData = BrowserChannelData()
            };
        ...
        protected static AbstractChannelData AbstractChannelData()
        {
