...
namespace Checkout.HandlePaymentsAndPayouts.Flow
{
    public class FlowClientTest : UnitTestFixture
    {
        ...
        public async Task CreatePaymentSession_Should_Call_ApiClient_Post()
        {
            ...
            // Act
            var result = await _flowClient.CreatePaymentSession(request);
        ...
        public async Task CompletePaymentSession_Should_Call_ApiClient_Post()
        {
            ...
            // Act
            var result = await _flowClient.CompletePaymentSession(request);
        ...
        {
            // Act & Assert
            await Should.ThrowAsync<CheckoutArgumentException>(async () => await _flowClient.CreatePaymentSession(null));
        }
        ...
        {
            // Act & Assert
            await Should.ThrowAsync<CheckoutArgumentException>(async () => await _flowClient.CompletePaymentSession(null));
        }
    }
}