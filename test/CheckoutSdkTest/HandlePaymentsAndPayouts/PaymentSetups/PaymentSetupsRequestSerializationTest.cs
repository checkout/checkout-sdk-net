...
namespace Checkout.HandlePaymentsAndPayouts.PaymentSetups
{
    ...
    public class PaymentSetupsRequestSerializationTest
    {
        ...
        public void ShouldRoundTripSerializeWithAllProperties()
        {
            ...
            var deserialized = (PaymentSetupsRequest)Serializer.Deserialize(json, typeof(PaymentSetupsRequest));
        ...
        public void ShouldDeserializeSnakeCaseJson()
        {
            ...
            var result = (PaymentSetupsRequest)Serializer.Deserialize(json, typeof(PaymentSetupsRequest));
        ...
        public void ShouldSerializeNewPaymentMethods()
        {
            ...
            var json = Serializer.Serialize(paymentMethods);
        ...
        public void ShouldDeserializeNewPaymentMethods()
        {
            ...
            var paymentMethods = (Checkout.Payments.Setups.Entities.PaymentMethods)
                Serializer.Deserialize(json, typeof(Checkout.Payments.Setups.Entities.PaymentMethods));
        ...
        public void ShouldSerializeAndDeserializeOrderAmountAllocations()
        {
            ...
            var deserialized = (Order)Serializer.Deserialize(json, typeof(Order));
