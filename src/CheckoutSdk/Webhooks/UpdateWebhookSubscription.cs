...
{
    /// <summary>
    /// Defines a <see cref="UpdateWebhookSubscription"/>.
    /// </summary>
    public class UpdateWebhookSubscription : Webhook
    {
        /// <summary>
        /// Creates a new <see cref="UpdateWebhookSubscription"/> instance.
        /// This class is suitable for updating an existing webhook.
        /// </summary>
        /// <param name="webhook">The base webhook.</param>
        public UpdateWebhookSubscription(IWebhook webhook)
        {
        ...
        public UpdateWebhookSubscription(string url, bool active, Dictionary<string, string> headers, List<string> eventTypes)
        {
