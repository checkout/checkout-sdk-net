...
namespace Checkout.Webhooks
{
    ...
    public class WebhooksClient : IWebhooksClient
    {
        ...
        public Task<WebhookResponse> RegisterWebhookAsync(WebhookRequest<RegistrationWebhook> webhookRequest, CancellationToken cancellationToken = default(CancellationToken))
        {
        ...
        public Task<WebhookResponse> UpdateWebhookAsync (string id, WebhookRequest<UpdateWebhook> webhookRequest, CancellationToken cancellationToken = default(CancellationToken))
        {
            return _apiClient.PutAsync<WebhookResponse>($"{path}/{id}", _credentials, cancellationToken, webhookRequest);
        }

        public Task<WebhookResponse> PartiallyUpdateWebhookAsync(string id, WebhookRequest<PartialUpdateWebhook> webhookRequest, CancellationToken cancellationToken = default(CancellationToken))
        {
