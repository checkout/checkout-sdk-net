...
{
    public class CardCreateResponseConverter : JsonConverter
    {
        public override bool CanWrite => false;

        public override bool CanConvert(Type objectType)
        {
            return typeof(AbstractCardCreateResponse).GetTypeInfo().IsAssignableFrom(objectType.GetTypeInfo());
        }
        ...
        private static AbstractCardCreateResponse Create(JToken jToken)
        {
