...
namespace Checkout.Issuing.Disputes.Common
{
    ...
    public enum IssuingDisputeFraudType
    {
        ...
        /// </summary>
        [EnumMember(Value = "counterfeit_card")]
        CounterfeitCard,
        ...
        /// </summary>
        [EnumMember(Value = "card_not_present_fraud")]
        CardNotPresentFraud,
        ...
        /// </summary>
        [EnumMember(Value = "merchant_misrepresentation")]
        ...
        /// </summary>
        [EnumMember(Value = "cardholder_manipulation")]
        CardholderManipulation,
        ...
        /// </summary>
        [EnumMember(Value = "incorrect_processing")]
        IncorrectProcessing,
