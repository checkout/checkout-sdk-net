...
namespace Checkout.Instruments.Four.Create
{
    public sealed class CreateBankAccountInstrumentRequest : CreateInstrumentRequest,
        IEquatable<CreateBankAccountInstrumentRequest>
    {
        ...
        public bool Equals(CreateBankAccountInstrumentRequest other)
        {
        ...
        {
            return ReferenceEquals(this, obj) || obj is CreateBankAccountInstrumentRequest other && Equals(other);
        }
