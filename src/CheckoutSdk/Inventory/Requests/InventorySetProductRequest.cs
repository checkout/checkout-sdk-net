...
{
    /// <summary>
    /// Request body for creating or updating a variant's product knowledge (merchandising metadata
    /// surfaced to AI agents). [BETA]
    /// </summary>
    public class InventorySetProductRequest
    {
        /// <summary> The product's title. (Required, constraints: maxLength 512) </summary>
        public string Title { get; set; }

        /// <summary> The product's description. (Required, constraints: maxLength 4000) </summary>
        public string Description { get; set; }

        /// <summary> URL of the product page. (Required, constraints: maxLength 2048) </summary>
        public string ProductUrl { get; set; }

        /// <summary> URL of the primary product image. (Required, constraints: maxLength 2048) </summary>
        ...
        /// <summary> The merchant's SKU for the product. (Optional, constraints: maxLength 128) </summary>
        ...
        /// <summary>
        /// The product's list price. (Optional; when sale_price is also set, sale_price must share
        /// this currency and be less than or equal to this amount)
        /// </summary>
        public InventoryMoney Price { get; set; }

        /// <summary>
        /// The product's sale price. (Optional; must share price's currency and be less than or
        /// equal to price)
        /// </summary>
        ...
        /// <summary>
        /// Groups variants of the same product (e.g. different colors/sizes). When set, color and
        /// size are both required. (Optional; spec text only, not a formal oneOf)
        /// </summary>
        ...
        /// <summary> The variant's color. Required when group_id is set. (Optional; spec text only) </summary>
        public string Color { get; set; }

        /// <summary> The variant's size. Required when group_id is set. (Optional; spec text only) </summary>
        ...
        /// <summary>
        /// The product's condition. Exact lowercase match. Defaults to <c>new</c>. (Optional)
        /// </summary>
