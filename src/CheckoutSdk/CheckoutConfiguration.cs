...
namespace Checkout
{
    public class CheckoutConfiguration
    {
        ...
        public CheckoutConfiguration(string secretKey, bool sandbox, string publicKey = null)
            : this(secretKey, sandbox ? SandboxUrl : ProductionUrl)
        {

        }

        public CheckoutConfiguration(string secretKey, string uri = null, string publicKey = null)
        {
