...
namespace Checkout.HandlePaymentsAndPayouts.Flow
{
    ...
    public interface IFlowClient
    {
        ...
        /// </summary>
        Task<PaymentSessionResponse> CreatePaymentSession(PaymentSessionRequest request,
        ...
        /// You must send the unmodified response body as the response of the handleSubmit callback.
        /// </summary>
        Task<PaymentSubmissionResponse> CreateAndSubmitPaymentSession(PaymentSessionCompleteRequest request,
            CancellationToken cancellationToken = default);
    }
}