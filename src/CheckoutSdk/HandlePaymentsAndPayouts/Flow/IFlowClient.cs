...
namespace Checkout.HandlePaymentsAndPayouts.Flow
{
    ...
    public interface IFlowClient
    {
        ...
        /// </summary>
        Task<PaymentSessionResponse> RequestPaymentSession(PaymentSessionRequest request,
        ...
        /// You must send the unmodified response body as the response of the handleSubmit callback.
        /// </summary>
        Task<PaymentSubmissionResponse> RequestAndSubmitPaymentSession(PaymentSessionCompleteRequest request,
            CancellationToken cancellationToken = default);
    }
}