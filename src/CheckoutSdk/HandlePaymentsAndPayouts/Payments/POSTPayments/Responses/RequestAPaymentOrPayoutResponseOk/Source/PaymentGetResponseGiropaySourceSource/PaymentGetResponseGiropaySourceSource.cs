namespace Checkout.HandlePaymentsAndPayouts.Payments.POSTPayments.Responses.RequestAPaymentOrPayoutResponse201.Source.PaymentGetResponseGiropaySourceSource
{
    /// <summary>
    ...
    public class PaymentGetResponseGiropaySourceSource : AbstractSource
    {
        ...
        /// </summary>
        public PaymentGetResponseGiropaySourceSource() : base(GetResponseGiropaySourceSourceType.Payment)
        {
        }
