...
{
    public sealed class DisputeEvidenceRequest : IEquatable<DisputeEvidenceRequest>
    {
        ...
        public bool Equals(DisputeEvidenceRequest other)
        {
        ...
        {
            return ReferenceEquals(this, obj) || obj is DisputeEvidenceRequest other && Equals(other);
        }
