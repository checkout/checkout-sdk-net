namespace Checkout.Authentication.Standalone.Common.Responses.GoogleSpa.NonHostedGoogleSpa
{
    /// <summary>
    /// Non Hosted google_spa Class
    /// Details of Google SPA (Secure Payment Authentication)
    /// </summary>
    public class NonHostedGoogleSpa : AbstractGoogleSpa
    {
        /// <summary>
        /// Initializes a new instance of the NonHostedGoogleSpa class.
        /// </summary>
        public NonHostedGoogleSpa() : base(GoogleSpaType.NonHosted)
        {
        }
