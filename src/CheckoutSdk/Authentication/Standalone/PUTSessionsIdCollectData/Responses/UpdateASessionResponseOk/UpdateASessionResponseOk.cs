...
namespace Checkout.Authentication.Standalone.PUTSessionsIdCollectData.Responses.UpdateASessionResponseOk
{
    /// <summary>
    /// Update a session Response 200
    /// Session updated successfully
    /// </summary>
    public class UpdateASessionResponseOk : Resource
    {
        /// <summary>
