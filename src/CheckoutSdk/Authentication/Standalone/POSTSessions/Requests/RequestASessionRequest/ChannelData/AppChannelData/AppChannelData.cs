...
{
    /// <summary>
    /// app channel_data Class
    /// The information gathered from the environment used to initiate the session
    /// </summary>
    public class AppChannelData : AbstractChannelData
    {
        /// <summary>
        /// Initializes a new instance of the AppChannelData class.
        /// </summary>
        public AppChannelData() : base(ChannelDataType.App)
        {
        }
