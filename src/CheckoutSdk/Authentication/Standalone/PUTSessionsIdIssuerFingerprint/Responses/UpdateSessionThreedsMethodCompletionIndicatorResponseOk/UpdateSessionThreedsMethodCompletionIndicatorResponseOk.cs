...
namespace Checkout.Authentication.Standalone.PUTSessionsIdIssuerFingerprint.Responses.
    UpdateSessionThreedsMethodCompletionIndicatorResponseOk
{
    /// <summary>
    /// Update session 3DS Method completion indicator Response 200
    /// Session updated successfully
    /// </summary>
    public class UpdateSessionThreedsMethodCompletionIndicatorResponseOk : Resource
    {
        /// <summary>
        ...
        /// [Optional]
        /// </summary>
        public AbstractGoogleSpa GoogleSpa { get; set; }
        ...
        /// <summary>
        /// Provides additional information about the 3DS authentication experience.
        /// [Optional]
        /// </summary>
