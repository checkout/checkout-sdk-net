...
namespace Checkout.Payments.Links
{
	public class PaymentLinksClient : AbstractClient, IPaymentLinksClient
	{
		...
		public Task<PaymentLinkDetailsResponse> Get(string reference, CancellationToken cancellationToken = default)
		{
			...
			return ApiClient.Get<PaymentLinkDetailsResponse>( BuildPath(PaymentLinksPath,reference), SdkAuthorization(), cancellationToken);
		}

		public Task<PaymentLinkResponse> Create(PaymentLinkRequest paymentLinkRequest, CancellationToken cancellationToken = default)
		{
