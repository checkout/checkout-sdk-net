...
namespace Checkout.Payments
{
    ...
    public class ThreeDSRequest
    {
        ...
        /// <summary>
        /// The Electronic Commerce Indicator security level associated with the 3D-Secure enrollment result. Required if using a third party MPI.
        /// </summary>
        [JsonProperty(PropertyName = "eci")]
        public string ElectronicCommerceIndicator { get; set; }
        /// <summary>
        /// Cryptographic identifier used by the card schemes to validate the cardholder authentication result (3D-Secure). Required if using an external MPI.
        /// </summary>
