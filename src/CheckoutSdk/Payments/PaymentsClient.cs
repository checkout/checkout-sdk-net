...
namespace Checkout.Payments
{
    ...
    public class PaymentsClient : IPaymentsClient
    {
        ...
        public Task<PaymentResponse> RequestAsync<TRequestSource>(PaymentRequest<TRequestSource> paymentRequest, string idempotencyKey = null, CancellationToken cancellationToken = default(CancellationToken)) 
            where TRequestSource : IRequestSource
        {
            return RequestPaymentAsync(paymentRequest, PaymentResponseMappings, idempotencyKey, cancellationToken);
        }
        ...
        public Task<CaptureResponse> CaptureAsync(string paymentId, CaptureRequest captureRequest = null, string idempotencyKey = null, CancellationToken cancellationToken = default(CancellationToken))
        {
        ...
        public Task<RefundResponse> RefundAsync(string paymentId, RefundRequest refundRequest = null, string idempotencyKey = null, CancellationToken cancellationToken = default(CancellationToken))
        {
        ...
        public Task<VoidResponse> VoidAsync(string paymentId, VoidRequest voidRequest = null, string idempotencyKey = null, CancellationToken cancellationToken = default(CancellationToken))
        {
        ...
        private async Task<PaymentResponse> RequestPaymentAsync<TRequestSource>(PaymentRequest<TRequestSource> paymentRequest, Dictionary<HttpStatusCode, Type> resultTypeMappings, string idempotencyKey, CancellationToken cancellationToken) where TRequestSource : IRequestSource
        {
