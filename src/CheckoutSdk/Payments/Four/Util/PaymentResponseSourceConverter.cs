    ...
    public class PaymentResponseSourceConverter : JsonConverter<IResponseSource>
    {
        ...
        public override IResponseSource Read(ref Utf8JsonReader reader, Type typeToConvert, JsonSerializerOptions options)
        {
            ...
            return typeName switch
            {
                ...
                string str when str.Equals(nameof(CardResponseSource), StringComparison.OrdinalIgnoreCase) =>
                    System.Text.Json.JsonSerializer.Deserialize<CardResponseSource>(ref reader)!,
                string str when str.Equals(nameof(CurrencyAccountResponseSource), StringComparison.OrdinalIgnoreCase) =>
                    System.Text.Json.JsonSerializer.Deserialize<CurrencyAccountResponseSource>(ref reader)!,
