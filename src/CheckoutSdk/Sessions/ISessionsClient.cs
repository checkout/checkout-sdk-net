...
namespace Checkout.Sessions
{
    ...
    {
        Task<SessionResponse> RequestSession(SessionRequest sessionRequest,
            CancellationToken cancellationToken = default);

        Task<GetSessionResponse> GetSessionDetails(string sessionId, CancellationToken cancellationToken = default);

        Task<GetSessionResponse> GetSessionDetails(string sessionSecret, string sessionId,
            CancellationToken cancellationToken = default);

        Task<GetSessionResponse> UpdateSession(string sessionId, ChannelData channelData,
            CancellationToken cancellationToken = default);
        ...
        Task<GetSessionResponseAfterChannelDataSupplied> Update3dsMethodCompletionIndicator(string sessionSecret,
